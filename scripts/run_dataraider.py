...
def main():
    ...
    parser.add_argument("--output_dir", type=str, help="Directory to save processed JSON data", default=None)
    ...
    output_dir = args.output_dir or config.get('json_dir', config.get('default_json_dir'))
