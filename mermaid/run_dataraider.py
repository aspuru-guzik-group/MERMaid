import os
import json
from mermaid.methods_dataraider import RxnOptDataProcessor
...
if __name__ == "__main__":
    ...
    processor.construct_initial_prompt(keys, new_keys, prompt_dir)
